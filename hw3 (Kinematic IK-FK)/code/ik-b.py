...
def constraint1(x):
    ...
    """
    # origin to end of first link
    p1 = [0.0, 0.0, 0.0]
    p2 = fk(x[:1], link_lengths[:1])
    return float(-line_sphere_intersection(p1, p2, obstacle_center, obstacle_radius))
